...
public class CarSpec
{
    ...
    public string CarId {get;set;} = "Not Available";
    public  string CarName {get;set;} = "Not Available";
    public string SatelliteNavigation {get;set;} = "Not Available";
    public string LeatherSeats {get;set;} = "Not Available";
    public string HeatedFrontSeats {get;set;} = "Not Available";
    public string BluetoothHandsfreeSystem {get;set;} = "Not Available";
    public string CruiseControl {get;set;} = "Not Available";
    public string AutomaticHeadlights {get;set;} = "Not Available";
